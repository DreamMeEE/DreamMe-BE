...
public class DataInitializer {
    ...
    public void initializeMembers() {
        ...
        Lucky lucky1 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/1728b6cd-c4d4-49ea-b3d7-86d7962fe5e2.png").keyword("총운잡몽").title("일상 속 즐거움을 찾아볼까요?").
                comment(
        ...
        Lucky lucky2 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/7efde938-ddda-435a-a0da-496d0c49109a.png").keyword("총운허몽").title("변화의 기운이 느껴지지 않나요?").comment(
        ...
        Lucky lucky3 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/65fdc633-ebb2-42fc-96e4-0ef0764c7a06.png").keyword("총운영몽").title("자기 자신을 믿으세요!").comment(
        ...
        Lucky lucky4 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/2e6b49ce-0caa-4292-8ab7-8a9d581045c3.png").keyword("총운정몽").title("행운이 가득가득").comment(
        ...
        Lucky lucky5 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/3ff32fe4-5c31-4317-8114-370d7c6e21bf.png").keyword("총운심몽").title("너무 부담갖지 않아도 돼요").comment(
        ...
        Lucky lucky6 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/eb9ce313-f3f9-427b-89b8-4f823e6aa8a9.png").keyword("애정운잡몽").title("서로 배려하는 마음을 가져보아요").comment(
                "잡몽은 일상적인 경험이 뒤섞인 꿈으로, 특별한 감정적 반응이나 심리적 변화를 주지 않는 경우가 많아요. 이런 꿈은 보통 스트레스나 피로로 인해 발생합니다. 사용자가 평소 겪은 일이나 기억들이 비논리적으로 엮여 나타나는 경우가 많아요. 꿈의 내용이 일상적이라 특별한 상징이 없지만, 때로는 자신이 놓친 감정이나 상황을 무의식적으로 처리하는 기회를 제공할 수 있어요. 잡몽을 꾸는 것은 뇌가 감정적, 신경적 부담을 풀기 위한 자연스러운 반응으로 볼 수 있습니다.\n" +
        ...
        Lucky lucky7 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/72bdad33-a175-476b-9483-59cfca72ad80.png").keyword("애정운허몽").title("새로운 매력 발견이 기대되네요!").comment(
                "허몽은 비현실적이고 상상적인 꿈으로, 현실에서 일어날 법하지 않은 상황들이 발생하는 꿈이에요. 이런 꿈은 뇌의 창의력과 상상력이 뚜렷하게 나타난 경우로, 무의식적으로 새로운 가능성이나 기회를 예고하는 경우가 많습니다. 허몽은 때로 뇌가 창의적인 방식으로 문제를 해결하거나, 자기 발전을 위한 무언가를 추구하는 과정을 나타낼 수 있어요.\n" +
        ...
        Lucky lucky8 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/99a75336-771b-41f5-8c5e-837931950016.png").keyword("애정운영몽").title("새로운 인연이 찾아오고 있어요!").comment(
                "영몽은 미래를 예고하는 듯한 직관적인 꿈으로, 때로는 예상치 못한 신호나 암시를 제공하는 경우가 많아요. 이 꿈은 뇌가 과거의 경험이나 현재의 상황을 바탕으로 미래를 예측하거나 중요한 정보를 직관적으로 전달하려는 경우입니다. 영몽은 신경과학적으로도 미래 예측 능력을 사용하는 뇌의 반응으로 해석할 수 있어요.\n" +
        ...
        Lucky lucky9 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/f10576a5-61ec-40a7-85d0-4cda08cf5aae.png").keyword("애정운정몽").title("사랑을 시작하기 좋은 시점이에요!").comment(
                "정몽은 행운과 긍정적인 기회를 나타내는 꿈으로, 기회나 성공을 암시합니다. 길몽이라고도 불리며, 개인의 삶에서 긍정적 변화나 성공적인 결과를 예고하는 꿈이에요.\n" +
                        "애정운에서는 새로운 시작이나 긍정적인 변화가 있을 것입니다. 사랑에 있어 행운이 따르는 시기이니, 연애에서 행복한 변화나 뜻밖의 발전이 있을 수 있습니다. 사랑을 시작하는 좋은 시점이에요.\n").build();
        Lucky lucky10 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/b22397b6-7aba-4d62-b761-328c5ae2a57c.png").keyword("애정운심몽").title("우리 서로 충분한 이야기를 나누어 보아요").comment(
                "심몽은 내면의 갈등이나 심리적 불안을 나타내는 꿈으로, 자신의 감정이나 심리적 문제를 무의식적으로 처리하는 과정에서 나타납니다. 심몽은 심리적 부담이나 불안을 해소하는데 중요한 역할을 합니다.\n" +
                        "애정에서는 갈등이나 오해가 발생할 수 있습니다. 상대방과의 관계에서 소통 부족이나 감정적 어려움이 있을 수 있으므로, 서로의 감정을 공유하고 이해하는 노력이 필요합니다.\n").build();

        Lucky lucky11 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/479f190d-0813-4bfe-b65d-3cf702e88dfe.png").keyword("제물운잡몽").title("티끌 모아 태산!").comment(
                "잡몽은 일상적인 경험이 뒤섞인 꿈으로, 특별한 감정적 반응이나 심리적 변화를 주지 않는 경우가 많아요. 이런 꿈은 보통 스트레스나 피로로 인해 발생합니다. 사용자가 평소 겪은 일이나 기억들이 비논리적으로 엮여 나타나는 경우가 많아요. 꿈의 내용이 일상적이라 특별한 상징이 없지만, 때로는 자신이 놓친 감정이나 상황을 무의식적으로 처리하는 기회를 제공할 수 있어요. 잡몽을 꾸는 것은 뇌가 감정적, 신경적 부담을 풀기 위한 자연스러운 반응으로 볼 수 있습니다.\n" +
        ...
        Lucky lucky12 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/62752146-2492-419e-9d3b-3df017d6b69a.png").keyword("제물운허몽").title("매순간 신중해야 해요").comment(
                "허몽은 비현실적이고 상상적인 꿈으로, 현실에서 일어날 법하지 않은 상황들이 발생하는 꿈이에요. 이런 꿈은 뇌의 창의력과 상상력이 뚜렷하게 나타난 경우로, 무의식적으로 새로운 가능성이나 기회를 예고하는 경우가 많습니다. 허몽은 때로 뇌가 창의적인 방식으로 문제를 해결하거나, 자기 발전을 위한 무언가를 추구하는 과정을 나타낼 수 있어요.\n" +
        ...
        Lucky lucky13 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/f839a468-968c-4054-a42e-b4377b5140a6.png").keyword("제물운영몽").title("본인을 한 번 더 믿어봐요!").comment(
                "영몽은 미래를 예고하는 듯한 직관적인 꿈으로, 때로는 예상치 못한 신호나 암시를 제공하는 경우가 많아요. 이 꿈은 뇌가 과거의 경험이나 현재의 상황을 바탕으로 미래를 예측하거나 중요한 정보를 직관적으로 전달하려는 경우입니다. 영몽은 신경과학적으로도 미래 예측 능력을 사용하는 뇌의 반응으로 해석할 수 있어요.\n" +
                        "재물운은 미래 예측과 관련된 부분이 강하게 나타납니다. 영몽에서 얻은 직감이나 예감이 재정적인 기회나 위험을 예고할 수 있습니다. 금전적인 결정을 내리기 전에, 본인의 직관을 믿고 빠르게 움직이는 것이 좋습니다.\n").build();
        Lucky lucky14 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/1b11f8de-f29e-4134-9694-bb9e9db0cd1b.png").keyword("제물운정몽").title("설마 나도 복권당첨?").comment(
                "정몽은 행운과 긍정적인 기회를 나타내는 꿈으로, 기회나 성공을 암시합니다. 길몽이라고도 불리며, 개인의 삶에서 긍정적 변화나 성공적인 결과를 예고하는 꿈이에요.\n" +
                        "재물운은 매우 긍정적입니다. 예상치 못한 금전적 기회가 다가오거나, 재정적인 안정을 경험할 수 있습니다. 재정적으로도 행운이 따를 시기이니, 투자나 재정 계획에 있어서 긍정적인 변화를 기대할 수 있습니다.\n").build();
        Lucky lucky15 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/f5b43de6-7a11-41c7-808e-03e5c3c33caa.png").keyword("제물운심몽").title("충동적인 과소비 금지!").comment(
                "심몽은 내면의 갈등이나 심리적 불안을 나타내는 꿈으로, 자신의 감정이나 심리적 문제를 무의식적으로 처리하는 과정에서 나타납니다. 심몽은 심리적 부담이나 불안을 해소하는데 중요한 역할을 합니다.\n" +
                        "재정적으로 다소 불안정한 시기입니다. 과도한 소비나 충동적인 지출을 자제하는 것이 중요합니다. 차분한 계획을 세워 재정 관리를 해 나가는 것이 필요합니다.\n").build();

        Lucky lucky16 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/9c0f56d9-a926-4d75-9f9b-6952d440cc58.png").keyword("직장운잡몽").title("우리 차근차근 나아가봐요").comment(
                "잡몽은 일상적인 경험이 뒤섞인 꿈으로, 특별한 감정적 반응이나 심리적 변화를 주지 않는 경우가 많아요. 이런 꿈은 보통 스트레스나 피로로 인해 발생합니다. 사용자가 평소 겪은 일이나 기억들이 비논리적으로 엮여 나타나는 경우가 많아요. 꿈의 내용이 일상적이라 특별한 상징이 없지만, 때로는 자신이 놓친 감정이나 상황을 무의식적으로 처리하는 기회를 제공할 수 있어요. 잡몽을 꾸는 것은 뇌가 감정적, 신경적 부담을 풀기 위한 자연스러운 반응으로 볼 수 있습니다.\n" +
        ...
        Lucky lucky17 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/fada7c6c-48f2-4dfe-9360-c56575e52e75.png").keyword("직장운허몽").title("기회를 쟁취하는 자!").comment(
                "허몽은 비현실적이고 상상적인 꿈으로, 현실에서 일어날 법하지 않은 상황들이 발생하는 꿈이에요. 이런 꿈은 뇌의 창의력과 상상력이 뚜렷하게 나타난 경우로, 무의식적으로 새로운 가능성이나 기회를 예고하는 경우가 많습니다. 허몽은 때로 뇌가 창의적인 방식으로 문제를 해결하거나, 자기 발전을 위한 무언가를 추구하는 과정을 나타낼 수 있어요.\n" +
        ...
        Lucky lucky18 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/86f9a247-ada0-4358-acd2-aa6f55b65d75.png").keyword("직장운영몽").title("지금 다가오고 있는 기회를 놓치지 마세요!").comment(
                "영몽은 미래를 예고하는 듯한 직관적인 꿈으로, 때로는 예상치 못한 신호나 암시를 제공하는 경우가 많아요. 이 꿈은 뇌가 과거의 경험이나 현재의 상황을 바탕으로 미래를 예측하거나 중요한 정보를 직관적으로 전달하려는 경우입니다. 영몽은 신경과학적으로도 미래 예측 능력을 사용하는 뇌의 반응으로 해석할 수 있어요.\n" +
                        "직장에서는 급격한 변화가 예고됩니다. 영몽은 다가오는 상황에 대한 직감적인 신호를 제공하므로, 직장 내에서 새로운 기회나 예상치 못한 상황에 대비해야 합니다. 직장에서의 상상치 못한 기회를 잘 포착하세요.\n").build();
        Lucky lucky19 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/84e30684-dfc6-4094-a8eb-16edbb962844.png").keyword("직장운정몽").title("열심히 노력한 사람에게 기회가 찾아오는 법이죠!").comment(
                "정몽은 행운과 긍정적인 기회를 나타내는 꿈으로, 기회나 성공을 암시합니다. 길몽이라고도 불리며, 개인의 삶에서 긍정적 변화나 성공적인 결과를 예고하는 꿈이에요.\n" +
                        "직장에서 승진이나 긍정적인 변화가 있을 가능성이 큽니다. 직장 내에서의 기회나 상사의 인정이 따를 수 있는 시점이에요. 적극적으로 자신의 능력을 발휘하며 승진의 기회를 잡아 보세요.\n").build();
        Lucky lucky20 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/f01f78c0-c852-4cc9-9a5a-cb35562ae8c3.png").keyword("직장운심몽").title("감정 컨트롤이 중요한 날이에요").comment(
                "심몽은 내면의 갈등이나 심리적 불안을 나타내는 꿈으로, 자신의 감정이나 심리적 문제를 무의식적으로 처리하는 과정에서 나타납니다. 심몽은 심리적 부담이나 불안을 해소하는데 중요한 역할을 합니다.\n" +
                        "직장에서의 갈등이나 불안감이 있을 수 있어요. 현재 상황에서 직장 내 관계나 업무에 대해 심리적인 불편함이 있을 수 있으므로, 자신의 감정을 잘 관리하는 것이 중요합니다.\n").build();

        Lucky lucky21 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/6a6bb784-f5a7-4401-94f6-9350835762d9.png").keyword("학업시험운잡몽").title("한 발, 한 발 꾸준히 나아가요").comment(
                "잡몽은 일상적인 경험이 뒤섞인 꿈으로, 특별한 감정적 반응이나 심리적 변화를 주지 않는 경우가 많아요. 이런 꿈은 보통 스트레스나 피로로 인해 발생합니다. 사용자가 평소 겪은 일이나 기억들이 비논리적으로 엮여 나타나는 경우가 많아요. 꿈의 내용이 일상적이라 특별한 상징이 없지만, 때로는 자신이 놓친 감정이나 상황을 무의식적으로 처리하는 기회를 제공할 수 있어요. 잡몽을 꾸는 것은 뇌가 감정적, 신경적 부담을 풀기 위한 자연스러운 반응으로 볼 수 있습니다.\n" +
        ...
        Lucky lucky22 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/92618ba3-0f6d-422f-abc1-00fc309faab9.png").keyword("학업시험운허몽").title("새로운 시도가 큰 도움이 될 수 있어요!").comment(
                "허몽은 비현실적이고 상상적인 꿈으로, 현실에서 일어날 법하지 않은 상황들이 발생하는 꿈이에요. 이런 꿈은 뇌의 창의력과 상상력이 뚜렷하게 나타난 경우로, 무의식적으로 새로운 가능성이나 기회를 예고하는 경우가 많습니다. 허몽은 때로 뇌가 창의적인 방식으로 문제를 해결하거나, 자기 발전을 위한 무언가를 추구하는 과정을 나타낼 수 있어요.\n" +
        ...
        Lucky lucky23 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/bb6d46f5-5a8f-4489-9807-ad3e274790d6.png").keyword("학업시험운영몽").title("예상치 못한 기회가 나에게?").comment(
                "영몽은 미래를 예고하는 듯한 직관적인 꿈으로, 때로는 예상치 못한 신호나 암시를 제공하는 경우가 많아요. 이 꿈은 뇌가 과거의 경험이나 현재의 상황을 바탕으로 미래를 예측하거나 중요한 정보를 직관적으로 전달하려는 경우입니다. 영몽은 신경과학적으로도 미래 예측 능력을 사용하는 뇌의 반응으로 해석할 수 있어요.\n" +
                        "학업에서 중요한 변화나 발전이 있을 수 있습니다. 시험을 준비하면서, 예상치 못한 팁이나 직관적인 힌트를 얻을 수 있을 것입니다. 직감을 활용하여 학업 목표를 달성하세요.\n").build();
        Lucky lucky24 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/648e177c-3fb8-445b-8575-0028fb262606.png").keyword("학업시험운정몽").title("10점 만점에 100점!").comment(
                "정몽은 행운과 긍정적인 기회를 나타내는 꿈으로, 기회나 성공을 암시합니다. 길몽이라고도 불리며, 개인의 삶에서 긍정적 변화나 성공적인 결과를 예고하는 꿈이에요.\n" +
                        "학업에서도 좋은 결과를 예상할 수 있습니다. 공부나 시험에서 성공적인 결과가 따를 가능성이 큽니다. 집중하고 노력하면 원하는 성과를 얻을 수 있어요.\n").build();
        Lucky lucky25 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/aebd70bf-be01-446e-b525-2a5f8bf2bde3.png").keyword("학업시험운심몽").title("마음의 짐을 하나씩 내려놓아요").comment(
                "심몽은 내면의 갈등이나 심리적 불안을 나타내는 꿈으로, 자신의 감정이나 심리적 문제를 무의식적으로 처리하는 과정에서 나타납니다. 심몽은 심리적 부담이나 불안을 해소하는데 중요한 역할을 합니다.\n" +
                        "학업에서의 불안이나 스트레스가 꿈에 나타났을 수 있습니다. 집중력을 높이기 위한 마음의 준비와 정신적 회복이 필요합니다. 스트레스를 관리하며 준비하는 것이 중요합니다.\n").build();

        Lucky lucky26 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/fc317f63-2511-425d-86d5-30f389a221da.png").keyword("건강운잡몽").title("충분한 휴식은 필수!").comment(
                "잡몽은 일상적인 경험이 뒤섞인 꿈으로, 특별한 감정적 반응이나 심리적 변화를 주지 않는 경우가 많아요. 이런 꿈은 보통 스트레스나 피로로 인해 발생합니다. 사용자가 평소 겪은 일이나 기억들이 비논리적으로 엮여 나타나는 경우가 많아요. 꿈의 내용이 일상적이라 특별한 상징이 없지만, 때로는 자신이 놓친 감정이나 상황을 무의식적으로 처리하는 기회를 제공할 수 있어요. 잡몽을 꾸는 것은 뇌가 감정적, 신경적 부담을 풀기 위한 자연스러운 반응으로 볼 수 있습니다.\n" +
        ...
        Lucky lucky27 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/bf2d7767-66a7-48b3-96f7-bbd5435cb11c.png").keyword("건강운허몽").title("충분한 휴식을 취해주세요").comment(
                "허몽은 비현실적이고 상상적인 꿈으로, 현실에서 일어날 법하지 않은 상황들이 발생하는 꿈이에요. 이런 꿈은 뇌의 창의력과 상상력이 뚜렷하게 나타난 경우로, 무의식적으로 새로운 가능성이나 기회를 예고하는 경우가 많습니다. 허몽은 때로 뇌가 창의적인 방식으로 문제를 해결하거나, 자기 발전을 위한 무언가를 추구하는 과정을 나타낼 수 있어요.\n" +
                        "건강은 전반적으로 양호하나, 정신적 과중이나 스트레스가 누적될 수 있습니다. 허몽이 비현실적인 꿈이라 상상력이 활발하게 작용한 만큼, 정신적 회복을 위한 시간이 필요할 수 있습니다. 휴식과 자기 관리에 신경 써주세요.\n").build();
        Lucky lucky28 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/06622614-1394-4a0d-82b9-5efd63c1a623.png").keyword("건강운영몽").title("너무 신경 쓰지 않아도 돼요").comment(
                "영몽은 미래를 예고하는 듯한 직관적인 꿈으로, 때로는 예상치 못한 신호나 암시를 제공하는 경우가 많아요. 이 꿈은 뇌가 과거의 경험이나 현재의 상황을 바탕으로 미래를 예측하거나 중요한 정보를 직관적으로 전달하려는 경우입니다. 영몽은 신경과학적으로도 미래 예측 능력을 사용하는 뇌의 반응으로 해석할 수 있어요.\n" +
                        "건강은 양호하지만, 신경 과민이 있을 수 있습니다. 스트레스나 불안감이 건강에 영향을 미칠 수 있으니, 영몽에서 나타나는 신호를 잘 해석하고 마음을 평온하게 유지하세요.\n").build();
        Lucky lucky29 = Lucky.builder().luckyImage("https://dreamme.s3.ap-northeast-2.amazonaws.com/ccbb0fd1-29a3-42ea-bfff-1588835afe70.png").keyword("건강운정몽").title("당신이 오늘의 에너자이저?").comment(
                "정몽은 행운과 긍정적인 기회를 나타내는 꿈으로, 기회나 성공을 암시합니다. 길몽이라고도 불리며, 개인의 삶에서 긍정적 변화나 성공적인 결과를 예고하는 꿈이에요.\n" +
                        "건강 상태는 매우 양호합니다. 에너지가 넘치는 시기이니, 운동이나 활동을 통해 더 건강한 상태를 유지할 수 있습니다.\n").build();
        Lucky lucky30 = Lucky.builder().luckyImage("").keyword("건강운심몽").title("공기 좋은 곳에서 명상 어떠세요?").comment(
                "심몽은 내면의 갈등이나 심리적 불안을 나타내는 꿈으로, 자신의 감정이나 심리적 문제를 무의식적으로 처리하는 과정에서 나타납니다. 심몽은 심리적 부담이나 불안을 해소하는데 중요한 역할을 합니다.\n" +
